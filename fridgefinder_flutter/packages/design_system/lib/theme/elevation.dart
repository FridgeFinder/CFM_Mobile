...
/// State layers for interactive surfaces
///
/// M3 uses overlay colors to indicate interactive states.
/// These are layered on top of the surface color.
class M3EStateLayer {
  M3EStateLayer._();
  ...
  /// Focus state overlay opacity
  static const double focusOpacity = 0.12;

  /// Press/Ripple state overlay opacity
  static const double pressOpacity = 0.12;

  /// Drag state overlay opacity
  static const double dragOpacity = 0.16;

  /// Disabled state opacity (for content, not overlay)
  static const double disabledContentOpacity = 0.38;

  /// Disabled state opacity (for container/surface)
  ...
  static Color getHoverColor(Color stateLayerColor) {
    return stateLayerColor.withValues(alpha: hoverOpacity);
  }

  /// Get focus overlay color
  static Color getFocusColor(Color stateLayerColor) {
    return stateLayerColor.withValues(alpha: focusOpacity);
  }

  /// Get press overlay color
  static Color getPressColor(Color stateLayerColor) {
    return stateLayerColor.withValues(alpha: pressOpacity);
  }

  /// Get drag overlay color
  static Color getDragColor(Color stateLayerColor) {
    return stateLayerColor.withValues(alpha: dragOpacity);
  }
  ...
  /// Apply state layer to a surface
  static Color applyStateLayer({
    required Color surface,
    required Color stateLayerColor,
    required double opacity,
  }) {
    final overlayColor = stateLayerColor.withValues(alpha: opacity);
